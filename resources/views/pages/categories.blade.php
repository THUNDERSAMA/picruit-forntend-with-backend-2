...
<div class="container" style="margin-top: 140px;">
    ...
    color: darkgreen;">What should we call you? </span></h3>
        ...
        <div class="row">
          ...
          <form id="app-cover"  method="POST"  action="{{ route('category.perform') }}" >
            <input type="hidden" name="_token" value="{{ csrf_token() }}" />     
            <input type="hidden" name="user_id" value="@php echo $users['id']; @endphp" />       
  ...
  <div id="select-box">
    ...
    <div id="options">
      <div class="option">
        <input class="s-c top" type="radio" name="category" value="1">
        <input class="s-c bottom" type="radio" name="category" value="1">
       <i class="fas fa-user-graduate"></i>
        <span class="label">Student</span>
        <span class="opt-val">student</span>
      </div>
      <div class="option">
        <input class="s-c top" type="radio" name="category" value="2">
        <input class="s-c bottom" type="radio" name="category" value="2">
        <i class="fas fa-chalkboard-teacher"></i>
        <span class="label">Teacher</span>
        <span class="opt-val">Teacher</span>
      </div>
      <div class="option">
        <input class="s-c top" type="radio" name="category" value="3">
        <input class="s-c bottom" type="radio" name="category" value="3">
        <i class="fas fa-child"></i>
        <span class="label">Freelacer</span>
        <span class="opt-val">Freelacer</span>
      </div>
      <div class="option">
        <input class="s-c top" type="radio" name="category" value="4">
        <input class="s-c bottom" type="radio" name="category" value="4">
        <i class="fas fa-id-card "></i>
        <span class="label">Employer</span>
        <span class="opt-val">Employer</span>
      </div>
      <div class="option">
        <input class="s-c top" type="radio" name="category" value="5">
        <input class="s-c bottom" type="radio" name="category" value="5">
  ...
  <div class="next_botton"><input type="submit" value="Next"/></div>
</form>
      </div>
